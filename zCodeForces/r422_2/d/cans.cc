...
// @@ !! LIM(sieve mod f:power debug)
// --> sieve f:gcd f:intDiv mod f:power f:<< debug
...
int main(/* int argc, char *argv[] */) {
  ...
  // auto primes = sieve(ll(5e3));
  vector<int> dirSieve = divisorSieve(r + 1);
