...
int main(/* int argc, char *argv[] */) {
  ...
  Fp plus_sum = A[0] + A[1];
  Fp plus_num = 1;
  Fp minus_sum = A[0] - A[1];
  Fp minus_num = 1;
  REP(i, 2, N) {
    Fp prev_plus_sum = plus_sum;
    Fp prev_plus_num = plus_num;
    Fp prev_minus_sum = minus_sum;
    Fp prev_minus_num = minus_num;
    plus_sum = prev_plus_sum + A[i] * prev_plus_num + prev_minus_sum + A[i] * prev_minus_num;
    plus_num = prev_plus_num + prev_minus_num;
    minus_sum = prev_plus_sum - A[i] * prev_plus_num;
    minus_num = prev_plus_num;
  }
