...
int main(/* int argc, char *argv[] */) {
  ...
  REP(i, 0, N) {
    ...
    tbl = tbl_init;
    tbl[0] = prev[0];
    tbl[1] = prev[1] + (c == 'c' ? prev[0] : Fp(0));
    tbl[2] = prev[2] + (c == 'h' ? prev[1] : Fp(0));
    tbl[3] = prev[3] + (c == 'o' ? prev[2] : Fp(0));
    tbl[4] = prev[4] + (c == 'k' ? prev[3] : Fp(0));
    tbl[5] = prev[5] + (c == 'u' ? prev[4] : Fp(0));
    tbl[6] = prev[6] + (c == 'd' ? prev[5] : Fp(0));
    tbl[7] = prev[7] + (c == 'a' ? prev[6] : Fp(0));
    tbl[8] = prev[8] + (c == 'i' ? prev[7] : Fp(0));
  }
  cout << tbl[8] << endl;
