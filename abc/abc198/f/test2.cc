...
struct static_modint : internal::static_modint_base {
  ...
  public:
    ...
    friend ostream& operator<< (ostream& os, const mint& t) {
      os << t._v;
      return os;
    }
...
int main() {
  ...
  if (1) {
    using mint = atcoder::static_modint<754974721>;
    vector<mint> vecA({1, 2, 3, 4});
    vector<mint> vecB({-1, 0, 1, 2});
  ...
  if (1) {
    ...
    auto res1 = atcoder::convolution_ll(vecA, vecB);
