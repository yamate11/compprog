...
int main(int argc, char *argv[]) {
  ...
  using mydouble = number<cpp_bin_float<50, digit_base_10, void, long long>>;
  mydouble p;
  ll n;
  cin >> p >> n;
  ...
  Matrix<mydouble> mat({{1.0-p, p}, {p, 1.0-p}});
  DLOG("n=", n);
  cout << mat.matpower(n).at(0,1) << endl;
