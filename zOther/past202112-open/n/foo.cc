...
// vs should be listed counter-clockwise 
...
int in_polygon2(const Point& pt, const Point& A, const Point& B, const Point& C) {
...
int main(/* int argc, char *argv[] */) {

  {
    ...
    cout << in_polygon2(Point(1.5, 1.999), A, B, C) << endl;
    cout << in_polygon2(Point(1.5, 2.000), A, B, C) << endl;
    cout << in_polygon2(Point(1.5, 2.001), A, B, C) << endl;
  }
