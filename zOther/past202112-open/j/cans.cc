...
int main(/* int argc, char *argv[] */) {
  ...
  ll N, Q; cin >> N >> Q;
  Matrix<ll> m2A{{0,1,0},{-1,0,N-1},{0,0,1}};
  Matrix<ll> m2B{{0,-1,N-1},{1,0,0},{0,0,1}};
  Matrix<ll> m3A{{-1,0,N-1},{0,1,0},{0,0,1}};
  Matrix<ll> m3B{{1,0,0},{0,-1,N-1},{0,0,1}};

  Matrix<ll> X{{1,0,0},{0,1,0},{0,0,1}};
  auto Y = X;
