...
public:
  ...
  const vector<FpG<mod>>& vecFact() const { return vFact; }
  FpG<mod> fact(int n) const { return vFact.at(n); }
  FpG<mod> comb(int n, int r) const {
...
// Pol::value_type should be a field.
